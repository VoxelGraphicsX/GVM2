...
namespace GVM::ThreeSamples
{
    ...
    struct alignas(16) WebglMultipleElementsHostVertex
    {
        glm::vec4 position;
    ...
    struct alignas(16) WebglMultipleElementsHostObjectData
    {
    ...
    struct alignas(16) WebglMultipleElementsHostInstanceData
    {
        glm::vec4 reserved;
    };

    /** Mirrors one material component entry. */
    struct alignas(16) WebglMultipleElementsHostMaterialData
    {
        glm::vec4 baseColorAndFlags;
    };

    /** Stores one exact CPU-generated entity before RenderSet allocation. */
    struct WebglMultipleElementsEntity
    {
        eastl::vector<WebglMultipleElementsHostVertex> vertices;
        eastl::vector<uint32_t> indices;
        WebglMultipleElementsHostObjectData objectData{};
        WebglMultipleElementsHostInstanceData instanceData{};
        WebglMultipleElementsHostMaterialData materialData{};
    };

    /** Builds the Three.js orientation-transform scene and records deterministic captures. */
    class WebglMultipleElementsRuntimeAdapter final
    {
    public:
    ...
    private:
        ...
        eastl::vector<WebglMultipleElementsEntity> entities;
