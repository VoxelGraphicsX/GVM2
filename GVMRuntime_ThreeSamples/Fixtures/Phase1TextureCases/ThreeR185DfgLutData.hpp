#ifndef GVM_THREE_R185_DFG_LUT_DATA_HPP
#define GVM_THREE_R185_DFG_LUT_DATA_HPP

#include <cstdint>

namespace GVM::ThreeSamples
{
    /** Stores the immutable Three.js r185 16x16 RG16F split-sum DFG lookup. */
    inline constexpr uint32_t ThreeR185DfgLutPackedPixels[] = {
    ...
    static_assert(
        sizeof(ThreeR185DfgLutPackedPixels) /
                sizeof(ThreeR185DfgLutPackedPixels[0u]) ==
            256u);
}
