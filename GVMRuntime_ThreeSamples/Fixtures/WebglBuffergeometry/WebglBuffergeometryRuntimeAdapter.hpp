...
{
    /** Connects the deterministic r185 transparent Float32 mesh to the private DSL renderer. */
    class WebglBuffergeometryRuntimeAdapter final
    {
    public:
        /** Builds the CPU scene and uploads authored attributes only through generated DSL methods. */
        ...
        /** Keeps the target-frame state immutable during deterministic host warm-up. */
        void beforeFrame(
    ...
    private:
        /** Validates the locked scenario and constructs the exact non-indexed Float32 geometry. */
        ...
        /** Writes RenderSet-free topology and transparent two-pass invariants. */
        ...
        uint32_t geometryFinalRandomState = 0u;
