...
namespace GVM::ThreeSamples
{
    ...
    struct alignas(16) WebglMaterialsToonHostVertex
    {
        glm::vec4 position;
    ...
    struct alignas(16) WebglMaterialsToonHostObjectData
    {
    ...
    struct alignas(16) WebglMaterialsToonHostInstanceData
    {
        glm::vec4 reserved;
    };

    /** Mirrors one material component entry. */
    struct alignas(16) WebglMaterialsToonHostMaterialData
    {
        glm::vec4 baseColorAndFlags;
    ...
    struct WebglMaterialsToonEntity
    {
        eastl::vector<WebglMaterialsToonHostVertex> vertices;
        eastl::vector<uint32_t> indices;
        eastl::vector<uint8_t> gradientTexture;
        WebglMaterialsToonHostObjectData objectData{};
        WebglMaterialsToonHostInstanceData instanceData{};
        WebglMaterialsToonHostMaterialData materialData{};
    };

    /** Builds the Three.js orientation-transform scene and records deterministic captures. */
    class WebglMaterialsToonRuntimeAdapter final
    {
    public:
    ...
    private:
        ...
        eastl::vector<WebglMaterialsToonEntity> entities;
