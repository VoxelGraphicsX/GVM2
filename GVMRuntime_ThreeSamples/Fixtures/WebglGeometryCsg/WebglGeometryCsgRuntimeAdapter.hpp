...
namespace GVM::ThreeSamples
{
    ...
    struct alignas(16) WebglGeometryCsgHostVertex
    {
        glm::vec4 position;
    ...
    struct alignas(16) WebglGeometryCsgHostObjectData
    {
    ...
    struct alignas(16) WebglGeometryCsgHostInstanceData
    {
        glm::vec4 reserved;
    };

    /** Mirrors one material component entry. */
    struct alignas(16) WebglGeometryCsgHostMaterialData
    {
        glm::vec4 baseColorAndFlags;
    };

    /** Stores one exact CPU-generated entity before RenderSet allocation. */
    struct WebglGeometryCsgEntity
    {
        eastl::vector<WebglGeometryCsgHostVertex> vertices;
        eastl::vector<uint32_t> indices;
        WebglGeometryCsgHostObjectData objectData{};
        WebglGeometryCsgHostInstanceData instanceData{};
        WebglGeometryCsgHostMaterialData materialData{};
    };

    /** Builds the Three.js orientation-transform scene and records deterministic captures. */
    class WebglGeometryCsgRuntimeAdapter final
    {
    public:
    ...
    private:
        ...
        eastl::vector<WebglGeometryCsgEntity> entities;
