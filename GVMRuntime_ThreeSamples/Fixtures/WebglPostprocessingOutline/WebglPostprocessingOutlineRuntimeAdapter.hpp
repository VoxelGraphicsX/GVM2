...
namespace GVM::ThreeSamples
{
    ...
    struct alignas(16) WebglPostprocessingOutlineHostObjectData
    {
    ...
    struct alignas(16) WebglPostprocessingOutlineHostInstanceData
    {
        glm::vec4 reserved;
    };

    /** Mirrors the shared white flat MeshPhong material component. */
    struct alignas(16) WebglPostprocessingOutlineHostMaterialData
    {
        glm::vec4 diffuseAndShininess;
        glm::vec4 specular;
    };

    /** Mirrors selection and outline phase flags. */
    struct alignas(16) WebglPostprocessingOutlineHostRenderFlags
    {
        uint32_t values[4]{};
    };

    /** Connects the exact 100-object deterministic Scene to its DSL Renderer. */
    class WebglPostprocessingOutlineRuntimeAdapter final
    {
    public:
    ...
    private:
        ...
        eastl::vector<WebglPostprocessingOutlineHostObjectData> objects;
        WebglPostprocessingOutlineHostInstanceData instanceData{};
        WebglPostprocessingOutlineHostMaterialData materialData{};
        WebglPostprocessingOutlineHostRenderFlags renderFlags{};
