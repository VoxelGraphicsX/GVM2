...
namespace GVM::ThreeSamples
{
    ...
    struct alignas(16) WebgpuLightprobeCubecameraHostObjectData final
    {
        glm::mat4 projection;
        glm::mat4 modelView;
    ...
    private:
        ...
        eastl::array<WebgpuLightprobeCubecameraFaceAsset, 6u> faces;
        eastl::array<WebgpuLightprobeCubecameraHostShData, 9u> shData;
        WebgpuLightprobeCubecameraHostObjectData objectData{};
        WebgpuLightprobeCubecameraHostInstanceData instanceData{};
        WebgpuLightprobeCubecameraHostMaterialData materialData{};
