...
{
    /** Mirrors one canonical translated BoxGeometry vertex. */
    struct alignas(16) MiscControlsMapHostVertex
    {
        glm::vec4 position;
    };

    /** Mirrors the camera, lights, and fog per-entity component. */
    struct alignas(16) MiscControlsMapHostObjectData
    {
    ...
    /** Mirrors one deterministic box translation and vertical scale. */
struct alignas(16) MiscControlsMapHostInstanceData
    {
        glm::vec4 translationAndHeight;
    };

    /** Mirrors the private flat MeshPhong material component. */
    struct alignas(16) MiscControlsMapHostMaterialData
    {
    ...
    /** Connects deterministic map-control CPU state to the generated renderer. */
    class MiscControlsMapRuntimeAdapter final
    {
    public:
        /** Builds the box template and allocates one 500-instance Scene entity. */
    ...
    private:
        ...
        MiscControlsMapHostObjectData objectData = {};
        MiscControlsMapHostMaterialData materialData = {};
