...
namespace GVM::ThreeSamples
{
    ...
    struct alignas(16) WebgpuMultipleElementsHostVertex
    {
        glm::vec4 position;
    ...
    struct alignas(16) WebgpuMultipleElementsHostObjectData
    {
    ...
    struct alignas(16) WebgpuMultipleElementsHostInstanceData
    {
        glm::vec4 reserved;
    };

    /** Mirrors one material component entry. */
    struct alignas(16) WebgpuMultipleElementsHostMaterialData
    {
        glm::vec4 baseColorAndFlags;
    };

    /** Stores one exact CPU-generated entity before RenderSet allocation. */
    struct WebgpuMultipleElementsEntity
    {
        eastl::vector<WebgpuMultipleElementsHostVertex> vertices;
        eastl::vector<uint32_t> indices;
        WebgpuMultipleElementsHostObjectData objectData{};
        WebgpuMultipleElementsHostInstanceData instanceData{};
        WebgpuMultipleElementsHostMaterialData materialData{};
    };

    /** Builds the Three.js orientation-transform scene and records deterministic captures. */
    class WebgpuMultipleElementsRuntimeAdapter final
    {
    public:
    ...
    private:
        ...
        eastl::vector<WebgpuMultipleElementsEntity> entities;
