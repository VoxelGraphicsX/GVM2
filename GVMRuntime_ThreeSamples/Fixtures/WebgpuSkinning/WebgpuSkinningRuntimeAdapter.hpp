...
namespace GVM::ThreeSamples
{
    ...
    struct alignas(16) WebgpuSkinningHostVertex final
    {
    ...
    struct alignas(16) WebgpuSkinningHostObjectData final
    {
        glm::vec4 cameraPositionAndExposure;
    };

    /** Mirrors the mandatory single instance record. */
    struct alignas(16) WebgpuSkinningHostInstanceData final
    {
        glm::vec4 reserved;
    };

    /** Mirrors the physical-material and light component. */
    struct alignas(16) WebgpuSkinningHostMaterialData final
    {
    ...
    static_assert(sizeof(WebgpuSkinningHostVertex) == 64u);
    static_assert(sizeof(WebgpuSkinningHostObjectData) == 16u);
    static_assert(sizeof(WebgpuSkinningHostInstanceData) == 16u);
    static_assert(sizeof(WebgpuSkinningHostMaterialData) == 48u);

    /** Connects the dedicated Michelle renderer to the frozen GLB and animation. */
    class WebgpuSkinningRuntimeAdapter final
    {
    public:
    ...
    private:
        ...
        WebgpuSkinningHostObjectData objectData = {};
        WebgpuSkinningHostInstanceData instanceData = {};
        WebgpuSkinningHostMaterialData materialData = {};
