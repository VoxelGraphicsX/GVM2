...
namespace GVM::ThreeSamples
{
    ...
    struct alignas(16) WebglPostprocessingFxaaHostVertex
    {
        glm::vec4 position;
        glm::vec4 normal;
        glm::vec4 color;
    ...
    struct alignas(16) WebglPostprocessingFxaaHostObjectData
    {
    ...
    struct alignas(16) WebglPostprocessingFxaaHostInstanceData
    {
    ...
    struct alignas(16) WebglPostprocessingFxaaHostMaterialData
    {
        glm::vec4 baseColor;
    ...
    struct WebglPostprocessingFxaaEntityState
    {
        eastl::string logicalId;
        eastl::vector<WebglPostprocessingFxaaHostVertex> vertices;
        eastl::vector<uint32_t> indices;
        WebglPostprocessingFxaaHostObjectData objectData = {};
        eastl::vector<WebglPostprocessingFxaaHostInstanceData> instances;
        WebglPostprocessingFxaaHostMaterialData materialData = {};
        GVM::Core::RenderEntityIndex entityIndex = UINT32_MAX;
    };

    /** Connects the FXAA example to its single Scene-owned RenderSet. */
    class WebglPostprocessingFxaaRuntimeAdapter final
    {
    public:
    ...
    private:
        ...
        eastl::vector<WebglPostprocessingFxaaEntityState> entities;
        eastl::string caseId;
