...
namespace GVM::ThreeSamples
{
    ...
    struct alignas(16) WebglInstancingMorphHostVertex final
    {
        glm::vec4 position;
        glm::vec4 color;
    ...
    struct alignas(16) WebglInstancingMorphHostObjectData final
    {
    ...
    struct alignas(16) WebglInstancingMorphHostInstanceData final
    {
        glm::mat4 model;
        glm::vec4 color;
    ...
    struct alignas(16) WebglInstancingMorphHostMaterialData final
    {
        glm::vec4 baseColor;
    ...
    struct alignas(16) WebglInstancingMorphHostShadowFlags final
    {
        glm::uvec4 values;
    };

    /** Owns one logical RenderSet entity and all of its uploaded component arrays. */
    struct WebglInstancingMorphEntityState final
    {
        eastl::string name;
        eastl::vector<WebglInstancingMorphHostVertex> vertices;
        eastl::vector<uint32_t> indices;
        eastl::vector<WebglInstancingMorphHostInstanceData> instances;
        eastl::vector<glm::vec4> morphTargets;
        WebglInstancingMorphHostObjectData objectData = {};
        WebglInstancingMorphHostMaterialData materialData = {};
        WebglInstancingMorphHostShadowFlags shadowFlags = {};
    ...
    class WebglInstancingMorphRuntimeAdapter final
    {
    public:
        ...
        {
            renderer.configureInspector(0.0f);
    ...
    private:
        ...
        eastl::array<WebglInstancingMorphEntityState, 2u> entities;
