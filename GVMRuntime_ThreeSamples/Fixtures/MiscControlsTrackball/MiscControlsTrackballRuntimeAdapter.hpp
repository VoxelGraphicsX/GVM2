...
namespace GVM::ThreeSamples
{
    ...
    struct alignas(16) MiscControlsTrackballHostVertex
    {
        glm::vec4 position;
    };

    /** Mirrors the camera, lights, and fog per-entity component. */
    struct alignas(16) MiscControlsTrackballHostObjectData
    {
    ...
    struct alignas(16) MiscControlsTrackballHostInstanceData
    {
        glm::vec4 translation;
    };

    /** Mirrors the private flat MeshPhong material component. */
    struct alignas(16) MiscControlsTrackballHostMaterialData
    {
    ...
    /** Connects deterministic trackball-control CPU state to the generated renderer. */
    class MiscControlsTrackballRuntimeAdapter final
    {
    public:
    ...
    private:
        ...
        MiscControlsTrackballHostObjectData objectData = {};
        MiscControlsTrackballHostMaterialData materialData = {};
