#include "WebgpuReversedDepthRuntimeAdapter.hpp"
...
namespace GVM::ThreeSamples
{
    namespace
    {
        ...
        void validateWebgpuReversedDepthScenario(
            ...
            eastl::vector<ReversedDepthHostObjectData> &objects)
        {
                 ...
                 ++meshIndex)
            {
                ...
                objects[meshIndex].normalDepthControl.y = 0.0f;
        ...
        void appendWebgpuReversedDepthPayload(
    ...
    void WebgpuReversedDepthRuntimeAdapter::initializeResources(
        GVM::Core::AbstractRendererImpl &renderer,
        GVM::Core::DeviceProxy inDevice,
        const ThreeSampleHostOptions &options)
    {
        validateWebgpuReversedDepthScenario(options);
        device = inDevice;
             ...
             ++meshIndex)
        {
            ...
            std::snprintf(
                vertexName,
                sizeof(vertexName),
                "WebgpuReversedDepthBufferVertices-%u",
                meshIndex);
            std::snprintf(
                indexName,
                sizeof(indexName),
                "WebgpuReversedDepthBufferIndices-%u",
                meshIndex);
            std::snprintf(
                objectName,
                sizeof(objectName),
                "WebgpuReversedDepthBufferObject-%u",
                meshIndex);
            std::snprintf(
                instanceName,
                sizeof(instanceName),
                "WebgpuReversedDepthBufferInstance-%u",
                meshIndex);
            std::snprintf(
                materialName,
                sizeof(materialName),
                "WebgpuReversedDepthBufferMaterial-%u",
                meshIndex);
            GVM::Core::RenderSetAllocInfo allocation;
            ...
            appendWebgpuReversedDepthPayload(
                allocation,
                WebgpuReversedDepthBufferSceneRenderSetComponents::
                    vertices,
                vertexName,
                vertices.data(),
                vertices.size() *
    ...
    void WebgpuReversedDepthRuntimeAdapter::beforeFrame(
        GVM::Core::AbstractRendererImpl &renderer,
        const ThreeSampleHostOptions &options,
        uint32_t frameIndex)
    {
    ...
    void WebgpuReversedDepthRuntimeAdapter::afterFrame(
        GVM::Core::AbstractRendererImpl &renderer,
        const ThreeSampleHostOptions &options,
        uint32_t frameIndex,
    ...
    void WebgpuReversedDepthRuntimeAdapter::shutdown(
        GVM::Core::AbstractRendererImpl &renderer,
        const ThreeSampleHostOptions &options)
    {
        (void)renderer;
    ...
    void WebgpuReversedDepthRuntimeAdapter::writeArtifacts(
        const ThreeSampleHostOptions &options,
        uint32_t frameIndex,
        uint32_t width,
        uint32_t height,
        const eastl::vector<uint8_t> &rgba) const
    {
        ...
        if (!options.captureMetadataPath.empty())
        {
            ...
            output
                ...
                << "  \"caseId\":\"webgpu_reversed_depth_buffer\",\n"
        ...
        if (!options.sceneSnapshotPath.empty())
        {
            ...
            output
                ...
                << "  \"screenPassCount\":3,\n"
                << "  \"drawCommandCount\":3,\n"
                << "  \"renderSetType\":\"WebgpuReversedDepthBufferSceneRenderSet\",\n"
                << "  \"componentSchema\":["
                ...
                << "    \"scenePasses\":["
                << "{\"name\":\"normal-depth\",\"renderClass\":\"WebgpuReversedDepthBufferNormalPass\",\"renderSetId\":\"scene-set\",\"renderSetBindingCount\":1,\"drawMode\":\"render-set-indexed-indirect\",\"invocationCount\":1,\"drawCommandCount\":1,\"usesStandaloneGeometry\":false,\"usesExplicitDrawCount\":false},"
                << "{\"name\":\"logarithmic-depth\",\"renderClass\":\"WebgpuReversedDepthBufferLogarithmicPass\",\"renderSetId\":\"scene-set\",\"renderSetBindingCount\":1,\"drawMode\":\"render-set-indexed-indirect\",\"invocationCount\":1,\"drawCommandCount\":1,\"usesStandaloneGeometry\":false,\"usesExplicitDrawCount\":false},"
                << "{\"name\":\"reversed-depth\",\"renderClass\":\"WebgpuReversedDepthBufferReversedPass\",\"renderSetId\":\"scene-set\",\"renderSetBindingCount\":1,\"drawMode\":\"render-set-indexed-indirect\",\"invocationCount\":1,\"drawCommandCount\":1,\"usesStandaloneGeometry\":false,\"usesExplicitDrawCount\":false}]\n"
                << "  }],\n"
                << "  \"scenePassSequence\":["
