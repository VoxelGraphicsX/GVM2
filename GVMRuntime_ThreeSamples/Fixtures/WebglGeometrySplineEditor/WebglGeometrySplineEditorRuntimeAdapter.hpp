...
namespace GVM::ThreeSamples
{
    ...
    struct alignas(16) WebglGeometrySplineEditorHostVertex
    {
        glm::vec4 position;
    ...
    struct alignas(16) WebglGeometrySplineEditorHostObjectData
    {
    ...
    struct alignas(16) WebglGeometrySplineEditorHostInstanceData
    {
        glm::vec4 reserved;
    };

    /** Mirrors one material component entry. */
    struct alignas(16) WebglGeometrySplineEditorHostMaterialData
    {
        glm::vec4 baseColorAndFlags;
    };

    /** Stores one exact CPU-generated entity before RenderSet allocation. */
    struct WebglGeometrySplineEditorEntity
    {
        eastl::vector<WebglGeometrySplineEditorHostVertex> vertices;
        eastl::vector<uint32_t> indices;
        WebglGeometrySplineEditorHostObjectData objectData{};
        WebglGeometrySplineEditorHostInstanceData instanceData{};
        WebglGeometrySplineEditorHostMaterialData materialData{};
    };

    /** Builds the Three.js orientation-transform scene and records deterministic captures. */
    class WebglGeometrySplineEditorRuntimeAdapter final
    {
    public:
    ...
    private:
        ...
        eastl::vector<WebglGeometrySplineEditorEntity> entities;
